...
public class telaIdade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/idade.jpg"))); // NOI18N

        txtAno.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtAno.setText("Ano Atual: ");

        lblAtual.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblAtual.setForeground(new java.awt.Color(0, 0, 255));
        lblAtual.setText("0");
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        int anoatual = Integer.parseInt(lblAtual.getText());
